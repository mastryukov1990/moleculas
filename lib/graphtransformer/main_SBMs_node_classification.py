...
def train_val_pipeline(MODEL_NAME, dataset, params, net_params, dirs):
    ...
    # Write network and optimization hyper-parameters in folder conf/
    ...
    from train.train_SBMs_node_classification import evaluate_network, train_epoch
    ...
    try:
        with tqdm(range(params["epochs"])) as t:
            for epoch in t:
                ...
                writer.add_scalar("tests/_acc", epoch_test_acc, epoch)
                writer.add_scalar(
